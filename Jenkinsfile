pipeline {
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/rupesh-hub/devops-day-06.git'
            }
        }
        ...
        stage('SonarQube Analysis') {
            steps {
                withSonarQubeEnv('sonar') {
                    sh """
                        cd backend &&
                        $SCANNER_HOME/bin/sonar-scanner -Dsonar.projectName=devops-day-06 -Dsonar.projectKey=devops-day-06 \
